...
class Asset(models.Model):
    ...
    business_unit = models.ForeignKey('BusinessUnit', blank=True, null=True,
                                      verbose_name='所属业务线')  # blank和null均为True，一般都是并存！
...
class Manufactory(models.Model):
    ...
    support_num = models.CharField(max_length=32, blank=True)
    memo = models.CharField(max_length=128, blank=True, verbose_name='备注')
...
class NewAssetApprovalZone(models.Model):
    ...
    asset_type = models.CharField(max_length=64, choices=asset_type_choices, blank=True, null=True)
    ...
    cpu_count = models.IntegerField(max_length=128, blank=True, null=True)
    cpu_core_count = models.IntegerField(blank=True, null=True)
    os_ditribution = models.CharField(max_length=64, blank=True, null=True)
